  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <form action="answer.php" method="GET">
      <div class="mdl-textfield mdl-js-textfield" id="base-a">
        ...
        <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="base-a-of-trapizoid">
      ...
      <div class="mdl-textfield mdl-js-textfield" id="base-b">
        ...
        <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="base-b-of-trapizoid">
      ...
      <div class="mdl-textfield mdl-js-textfield" id="height">
        ...
        <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="height-of-the-trapizoid">
